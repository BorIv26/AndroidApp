...
class GetStorageUnitByIdUseCase @Inject constructor(
    private val repository: Repository
) {
    operator fun invoke(id: String): Flow<Resource<StorageUnitItemDto>> {
        return repository.getStorageUnitById(id)
    }
}